package com.mattyork.coinspotting.Activities;
...
import com.mattyork.coinspotting.R;
import com.mattyork.coinspotting.Adapters.PostsCellAdapter;
import com.mattyork.coinspotting.Fragments.LeftMenuFragment;
import com.mattyork.coinspotting.Fragments.LeftMenuFragment.OnLeftMenuSettingChangedListener;
import com.mattyork.coinspotting.Helpers.SettingsManager;
import com.mattyork.jarcs.CSWebService.PostFilterType;
import com.mattyork.jarcs.AsyncTasks.LoadPostsWithFilterAsyncTask;
...
public class MainActivity extends FragmentActivity implements OnItemClickListener, OnLeftMenuSettingChangedListener, OnRefreshListener {
	...
	ArrayList<CSPost> posts = new ArrayList<CSPost>();
	LeftMenuFragment leftMenuFragment;
	PullToRefreshAttacher mPullToRefreshAttacher;
	public static CSPost selectedPost;
	...
	public void getPostsWithFilterType(PostFilterType type) {
		...
		LoadPostsWithFilterAsyncTask task = new LoadPostsWithFilterAsyncTask(type){
			...
			@Override
			protected void onPostExecute(java.util.ArrayList<CSPost> result) {
				posts = result;
	...
	public void didSelectFilterPosts(PostFilterType type) {
		...
		//Clear posts
		postsListView.setAdapter(new PostsCellAdapter(MainActivity.this, getThemedCellLayoutId(), new ArrayList<CSPost>()));
