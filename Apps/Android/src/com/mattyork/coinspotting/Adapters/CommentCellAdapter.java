package com.mattyork.coinspotting.Adapters;
...
import com.mattyork.jarcs.CSObjects.CSComment.CommentType;

public class CommentCellAdapter extends ArrayAdapter<CSComment> {
	ArrayList<CSComment> comments;
	...
	public CSComment getItem(int position) throws IndexOutOfBoundsException {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		mTextTextView.setLinkTextColor(context.getResources().getColor(R.color.cs_pink));
